...
public interface AuthenticationListener {
     ...
     * @param errorMessage  An informative string given by the underlying fingerprint sdk that can
     *                      be displayed in the ui. This string is never null, and will be localized
